...
def import_class_definitions():
    class_def = "Behavioral Health: Can only be applied to people, The definition of behavioral health in this context is The promotion of mental health, resilence and wellbeing, the treatment of mental and substance use disorders, and support for these peoples along with their families. Behavioral health includes current behavioral health crisis as well as marking cases that could be considered as having the potential to cause a future behavioral health crisis,The goal of Behavioral Health Classification is early detection and finding signs that may lead to early treatment and better handling of effected individuals therefore there is not the need to assess clear and present danger but any level of risk can warrant classification. The classes of Behavioral Health is as follows:\nMental Health: Involving an individual with a diagnosed mental disorder, like schizophrenia or sucidal ideations, however this can include individuals that are having a mental health crisis, these mental health crisis can be anxiety attacks, paranoia, anger issues,clearly unusual behaviors, or other materializations of mental health incidents\nDomestic Social: Involving multiple Individuals in a home setting, like husband/wife or parent/children domestic disputes,and all other kinds of domestic disputes and incidents including child custody disputes, It is not necessary for it to be in a home setting if the relationship between the people is domestic.Events involving conflicts between people, with the potential to reoccur are generally considered Domestic Social regardless of whether the parties involved came to an agreement.\nNonDomestic Social: Involving multiple individuals not in a home setting, like comitting crimes on those not related to the perpretrator (This is rare by the way)\nSubstance Abuse: Individual with persistent drug/alchohol abuse problems, Posession alone is not enough to indicate abuse problems. If an officer pulls somebody over for a traffic stop and they are not under the influence but they are in possession of controlled substances it is not substance abuse, so look for evidence of abuse, If the only evidence is the oder of marijuana then it is Other"
    
    return class_def


def import_observed_definitions():
    class_def = "Behavioral Health: Can only be applied to people, any reports involving animals would automatically be classified as Other\n Mental Health: Involving an individual with a diagnosed mental disorder, like schizophrenia or suicidal ideations, however this can include individuals that are having a mental health crisis like paranoia or anxiety\nDomestic Social: Involving multiple Individuals in a home setting, like husband/wife or parent/children domestic disputes ,and all other kinds of domestic disputes, It is not necessary for it to be in a home setting if the relationship between the people is domestic, or it's classified in the report as a domestic dispute. Custody disputes that result in arguments are also Domestic Social\n NonDomestic Social: Involving multiple individuals not in a home setting, like committing crimes on those not related to the perpetrator (This is rare by the way)\nSubstance Abuse: Individual with persistent drug/alchohol abuse problems, Posession alone is not enough to indicate abuse problems. If an officer pulls somebody over for a traffic stop and they are not under the influence, but they are in possession of controlled substances it is not substance abuse, so look for evidence of abuse, If there is no evidence besides the odor of a drug like marijuana or presence of marijuana especially if no arrests were made it would be considered Other, in any case that the only evidence is the ordor of marijuana it should be Other. Other considerations, is that Mental Health usually takes precedence over other behavioral health classifications. Additionally, when evaluating domestic disputes in particular, if it is on the borderline, give careful consideration before labeling it other."
    pass